...
<!-- Mirrored from wegodesign.net/wego-theme-themeforest-html-template/shop-grid3.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Oct 2016 05:13:42 GMT -->
<!-- Added by HTTrack -->
				...
				<!-- <div class="block block-catalog-toolbar clearfix">
							...
							<div class="select">
								<select>
									...
									<option value="96">Show: 96 items</option>
								</select>
							</div>
							...
							<div class="select">
								<select>
									<option value="0" disabled selected>Choose color</option>
