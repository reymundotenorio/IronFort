...
<!-- Mirrored from wegodesign.net/wego-theme-themeforest-html-template/login2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Oct 2016 05:11:38 GMT -->
		...
		<div class="page">
			...
			<div class="page-intro">
				...
				<div class="grid-row clearfix">
					...
					<div class="page-subtitle">Bienvenido a iRONfort</div>s
					<div class="bread-crumbs"><a href="index.php">Inicio</a> - Ingresar</div>
				</div>
			</div>
			<!--/ page intro -->
					...
					<div class="grid-row">
						...
						<div class="grid-col grid-col-4">
							...
							<div class="block block-login">
								<div class="block-head">Iniciar sesión en su cuenta</div>
								<form action="#" class="block-cont">
									...
									<label class="checkbox"><input type="checkbox"><i class="fa fa-check"></i>Recuérdeme en esta computadora</label>
									<button type="submit" class="button">Iniciar sesión</button>
										<p>Aún no tienes cuenta? <a href="register.php">Regístrate aquí</a></p>
									<p><a href="recovery.php">Olvidé mi contraseña</a></p>
								</form>
							</div>
							<!--/ login -->
						</div>
